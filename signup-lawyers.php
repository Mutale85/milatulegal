	...
	<div class="container mt-5">
		<div class="row">
			<div class="col-md-12 mt-5">
				<div class="coverDiv">
					<h4 class="mb-5 border bg-New p-2 text-center text-white ">Create a lawyers Account</h4>
					<form id="registerForm" method="post">
						<div class="form-group mb-3">
			       		...
			       		<div class="form-group mb-3">
			       			<label class="mb-2 text-dark">Select Province and Town</label>
							<div class="input-group">
								...
								<select class="form-control" name="location_town" id="location_town">
	...
	<script>
		...
		$(document).ready(function(){
			$("#registerForm").submit(function(e){
				e.preventDefault();
				var url = 'parsers/registerLawyer';
				$.ajax({
					url:url,
					method:"POST",
					data:$(this).serialize(),
