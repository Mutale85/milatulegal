<?php 
	...
	if (isset($_POST['sender_id'])) {
		...
		$sql = $connect->prepare("INSERT INTO `table_messages`(`parent_id`, `sender_id`, `receiver_id`, `subject`, `message`) VALUES (?, ?, ?, ?, ?) ");
		$ex = $sql->execute([$parent_id, $sender_id, $receiver_id, $subject, $message]);
		if($ex){
