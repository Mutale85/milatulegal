<?php 
	...
	if (isset($_POST['province'])) {
		...
		$query = $connect->prepare("SELECT * FROM table_members WHERE user_type = 'lawyer' AND province = ? ");
   ...
   <?php	
	...
	?>
		<div class="card mb-4">
			<div class="card-body">
				<h5>No lawyers found in <?php echo getProvince($connect, $provinceID)?> Province</h5>	
			</div>
		</div>
	<?php		
		}
