    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                <?php 
                    if($count > 0){
                        foreach($query->fetchAll() as $row){    
                            extract($row);
                ?>
                    <a href="lawyers/read?mid=<?php echo $id?>" class="dropdown-item">
                    <!-- Message Start -->
                        <div class="media">
                            <img src="dist/img/user1-128x128.jpg" alt="User Avatar" class="img-size-50 mr-3 img-circle">
                            <div class="media-body">
                            <h3 class="dropdown-item-title">
                                <?php echo getUserByPhoneNumber($connect, $sender_id)?>
                ...
                ?>
                <a href="lawyers/received-messages" class="dropdown-item dropdown-footer">See All Messages</a>
            </div>
        </li>
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                ...
                ?>
                    <div class="dropdown-divider"></div>
                        <a href="lawyers/case-search-cases" class="dropdown-item">
                            <?php echo $case_title?>
                            <span class="float-right text-muted text-sm"><?php echo time_ago_check($date_created)?></span>
                        </a>
                ...
                <div class="dropdown-divider"></div>
                <a href="lawyers/case-search-cases" class="dropdown-item dropdown-footer">See All Notifications</a>
            </div>
        </li>
        <li class="nav-item">
