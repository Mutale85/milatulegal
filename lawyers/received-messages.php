                                            ...
                                            <tbody>
                                                <?php
                                                    ...
                                                    foreach ($query->fetchAll() as $row) {
                                                        extract($row);
                                                        if($message_status == 0){
                                                            $message_status = '<a href="'.$id.'" class="btn btn-primary bt-sm see_message"> <i class="bi bi-envelope"></i></a>  <a href="'.$id.'" class="btn btn-primary btn-sm see_message"> Reply</a> ';
                                                        }else{
                                                ...
                                                ?>
                                                <tr>
                                                    <td><?php echo getUserByPhoneNumber($connect, $sender_id)?></td>
        ...
        $(function(){
            $(document).on("click", ".delete_message", function(e){
                ...
                if(confirm("You wish to delete the message you sent.")){
                    $.ajax({
                        url:"lawyers/processor/receiverDeleteMessage",
                        method:"post",
